...
// ✅ these files are in the SAME folder as this page
...
const RecipesPage = () => {
  ...
  const [newRecipe, setNewRecipe] = useState({
    ...
    instructions: "",
    ingredients: [
      { ing: "Pasta", qty: 500, unit: "g" },
      { ing: "Tomato Sauce", qty: 400, unit: "ml" },
    ],
  });
        ...
        <CardContent sx={{ p: 3 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
            ...
            <FormControl size="small">
              ...
              <Select label="Dish Type" defaultValue="All">
            ...
            <FormControl size="small">
              ...
              <Select label="Cost Range" defaultValue="Any">
      ...
      <Card>
        <CardContent sx={{ p: 3, display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {newRecipe.ingredients.map((ing, idx) => (
            <Box key={idx} sx={{ display: "grid", gridTemplateColumns: "5fr 4fr 3fr", gap: 2 }}>
              <TextField
                fullWidth
                label="Ingredient"
                value={ing.ing}
                onChange={(e) => updateIng(idx, "ing", e.target.value)}
              />
              <TextField
                fullWidth
                label="Quantity"
          ...
          <Button
            ...
            onClick={() =>
              setNewRecipe((r) => ({
                ...r,
                ingredients: [...r.ingredients, { ing: "", qty: 0, unit: "g" }],
              }))
            }
          >
            Add Ingredient
